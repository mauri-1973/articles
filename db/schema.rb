...
ActiveRecord::Schema[7.2].define(version: 2024_10_17_234519) do
  ...
  create_table "commentnews", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["post_id"], name: "index_commentnews_on_post_id"
    t.index ["user_id"], name: "index_commentnews_on_user_id"
  end
  ...
  add_foreign_key "commentnews", "posts"
  add_foreign_key "commentnews", "users"
